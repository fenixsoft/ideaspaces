...
只有严格定义了极限以后，才可以准确定义 **连续（Continuous）**。连续是描述函数"没有断裂"的数学概念。直观上，连续函数的图像可以一笔画出，不需要抬笔。它的数学定义为：函数 $f$ 在点 $a$ 处连续，当且仅当满足以下三个条件：
...
1. 证明：如果 $f$ 在 $x_0$ 处可导，则 $f$ 在 $x_0$ 处连续。（提示：利用极限的运算法则）
    <details>
    <summary>参考答案</summary>
